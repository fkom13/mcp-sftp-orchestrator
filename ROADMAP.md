# Roadmap MCP Orchestrator — v8.2.0 → v9.0.0 (historique)

> **Release actuelle : 11.8.0.** Ce document conserve la roadmap historique v8/v9 ; voir `CHANGELOG.md` pour l'état courant.
